...
from .snapshot import CourseAttemptSnapshot, StudentSnapshot, KnowledgeSnapshot, PriorStudyRequirement, ElectiveQuota, PolicySource, SourceManifest
...
__all__ = [
    "PriorStudyRequirement", "ElectiveQuota", "PolicySource", "SourceManifest", "KnowledgeVersion", "CourseAttemptSnapshot", "StudentSnapshot", "KnowledgeSnapshot",
