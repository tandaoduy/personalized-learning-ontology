...
from flask_app.models.recommendation import RecommendedCourse
...
def test_risk_result_exposes_only_documented_levels(student, recommendation_engine):
    ...
    result = __import__("flask_app.services.progress_risk_analyzer", fromlist=["ProgressRiskAnalyzer"]).ProgressRiskAnalyzer(recommendation_engine).assess_student(student)
