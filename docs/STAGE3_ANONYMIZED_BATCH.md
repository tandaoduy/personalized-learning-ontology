...
Giới hạn phải nêu khi sử dụng kết quả: `next-term` là proxy chứ chưa ánh xạ lịch đào tạo thực tế; Academic Risk là proxy; phiên bản CTĐT/rule phải được diễn giải theo manifest của lượt chạy. Batch không thay thế xác nhận chính thức của Trường và không trả lời RQ3/LTR.
