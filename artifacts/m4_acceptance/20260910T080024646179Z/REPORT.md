...
- Validator: 2 plan valid; phương án đầu 15 tín chỉ.
- Risk: 2 plan, mức low, score 0.1176.
- Ranking: chọn 2 plan; đề xuất `RUN_m4-SV001-plan-1`; ngưỡng Jaccard 0.30.
- Diversity giữa hai plan: 0.3333.
- Đối chứng: thêm CCN6203 sai chuyên ngành; Validator phát hiện `curriculum_membership`.
- Trạng thái pipeline: `explaining`; kiểm thử: xem tests.txt / chưa chạy.
