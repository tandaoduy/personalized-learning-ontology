(function () {
    ...
    function showAlert(message, options = {}) {
        ...
        const iconSvg = {
            ...
            warning: `<svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" class="ui-alert__icon-svg"><circle cx="12" cy="12" r="10" fill="#f59e0b" stroke="none"></circle><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" d="M12 8v4m0 4h.01"></path></svg>`,
