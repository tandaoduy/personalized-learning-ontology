...
Chạy từ thư mục gốc:
    python scripts/benchmark_algorithms.py --limit 20 --output benchmark_results.csv
"""
...
# Cho phép chạy trực tiếp ``python scripts/benchmark_algorithms.py`` từ thư mục gốc.
