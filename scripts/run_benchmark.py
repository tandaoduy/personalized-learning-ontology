...
"""
    ...
    mapping = {
        "tests/test_security_controls.py": "Bảo mật (Hash, Session, Phân quyền)",
        "tests/test_recommendation_api_integration.py": "API Gợi ý môn học",
        "tests/test_recommendation_engine.py": "Thuật toán gợi ý môn học",
        "tests/test_progress_risk_analyzer.py": "Phân tích rủi ro tiến độ",
        "tests/test_deep_business_rules.py": "Quy tắc nghiệp vụ học vụ (Song hành, Tiên quyết)",
        "tests/test_sparql.py": "Truy vấn Ontology SPARQL",
        "tests/test_student_data_service.py": "Xử lý dữ liệu sinh viên",
        "tests/test_ui_integration.py": "Luồng giao diện người dùng (UI Integration)",
    }
